...
The machine-readable preparation record is `src/data/da-001-release-preparation.json`. The private-source canonicalization, source-alignment audit, editorial proof, history-cleanup decision, and remaining release blockers are recorded in `docs/editorial/da-001-release-preparation.md`.
