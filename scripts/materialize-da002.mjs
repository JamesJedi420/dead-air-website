...
const legacyWorkTitleToken = ["The", " Winter", " Guest"].join("");
...
const chronologyMetadata = [
  ...
  "chronologyNote: Placed after DA-001 in the archive's relative chronology; the exact interval remains unresolved.",
  "follows:",
  "  - collection: stories",
...
// REN-001 through REN-005 preserve the hash-locked v12 repository source while
