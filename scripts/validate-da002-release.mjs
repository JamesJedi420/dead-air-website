...
const summary = "A documentary crew returns to Cedar Plain High for a final session with a medium. In the basement, equipment fails, a fire door moves, and a sound recording leaves much to interpretation.";
