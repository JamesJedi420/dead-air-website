...
if (!da004.includes("revision: Final Approved Story v1.10")) {
  throw new Error("DA-004 must remain the authoritative Final Approved Story v1.10 output while older SPE-2893 DA-004 transforms are bypassed.");
}
...
await writeFile(
  ...
  `${JSON.stringify({
    ...
    bypassedDA004Revision: "Final Approved Story v1.10",
    status: "pass",
  }, null, 2)}\n`,
  "utf8",
);
...
console.log(
  `Validated ${accountedApprovalDeltas} SPE-2893 deltas across DA-001–DA-003; DA-004's 14 older publication-layer deltas are superseded by direct authoritative Final Approved Story v1.10 materialization and validated separately.`,
);
