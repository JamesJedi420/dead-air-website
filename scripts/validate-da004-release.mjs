...
const assets = [
  "https://res.cloudinary.com/szvtq9d8/image/upload/v1789370641/dead-air/da-004/publication/da004_art001_v2_1_16x9_1600x900.webp",
  "https://res.cloudinary.com/szvtq9d8/image/upload/v1789370654/dead-air/da-004/publication/da004_art001_v2_1_2x3_1024x1536.webp",
...
for (const asset of assets) if (!sourceText.includes(asset)) throw new Error(`DA-004 publication source missing approved v2.1 asset ${asset}`);
...
console.log("DA-004 release validation PASS: public route, indexability, publication metadata, v2.1 responsive art, archive, RSS, sitemap, and leak controls confirmed.");
