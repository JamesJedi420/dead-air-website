...
if (issues.length > 0) {
  throw new Error(
    `Scoped SPE-2893 publication-layer application found ${issues.length} deterministic target mismatch(es). See artifacts/spe2893-validation.json.`,
  );
}
